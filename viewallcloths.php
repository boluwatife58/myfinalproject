    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style='justify-content:flex-end'>
      <ul class="navbar-nav mb-2 mb-lg-0" id='links'>
       ...
       <!-- header div-->
                <div class='row'>
            <div class='col head1'>
                <p class='text-center'>All Cloths</p>
                 </div>
             </div>
          ...
          <div class="card-body text-light text-center" style="background-color: black; min-height:7em; font-weight: bold;">
           <?php 
                ...
                <span><?php echo $prdprice ;?></span>
                    ...
                    <button type='submit' name='submit' class='btn btn-primary' id='btbuy' style='width:100%; border-radius: 40px;' data-bs-toggle="modal" data-bs-target="#example<?php echo $value['product_id']; ?>">Buy</button>
...
<!-- Modal -->
<div class="modal fade" id="example<?php echo $value['product_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Product Details</h5>
        <button type="button?id=<?php echo $value['product_id']; ?>" class="close" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       <div class='row'>
           <div class='col' style="border-radius: 50px; border:1px solid blue; width: 5px;">
